    ...
    <div className="absolute h-full w-full bg-white/30 backdrop-blur-[2px] top-0 left-0">
      <form ref={editFormRef} className="edit-form" onSubmit={handleSubmit}>
        ...
        <X
          ...
          onClick={handleClose}
        />
        <label className="text-sm text-neutral-700" htmlFor="title">
          title
        </label>
        <input
          ...
          placeholder="Title"
        />
        <label className="text-sm text-neutral-700" htmlFor="description">
          description
        </label>
        <textarea
        ...
        />
        <label className="text-sm text-neutral-700" htmlFor="category">
          category
        </label>
        <input
          className="input-primary w-full"
        ...
        />
        <label className="text-sm text-neutral-700" htmlFor="DatePicker">
          due to
        </label>
        <DateInput
